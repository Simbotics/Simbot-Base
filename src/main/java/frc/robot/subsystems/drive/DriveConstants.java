...
public class DriveConstants {
    ...
    /**
     * The simulated voltage necessary to overcome friction for swerve. This is only used for simulation
     */
    ...
    /**
     * The inertia of the drive and steer motors in the swerve modules. These should
     * be left to default
     */
    ...
    /**
     * The CAN IDs of the drive motors in the swerve modules
     * NOTE: Be sure to change these to the correct values at the start of the
     * season
     */
    ...
    /**
     * The CAN IDs of the steer motors in the swerve modules
     * NOTE: Be sure to change these to the correct values at the start of the
     * season
     */
    ...
    /**
     * The CAN IDs of the encoders in the swerve modules
     * NOTE: Be sure to change these to the correct values at the start of the
     * season
     */
    ...
    /**
     * The X and Y positions of the swerve modules relative to the center of the robot in inches
     * NOTE: Be sure to change these to the correct values at the start of the season
     */
    ...
    public static final DriveSubsystem DriveTrain =
      new DriveSubsystem(
          DrivetrainConstants, SwerveModules.FrontLeft, SwerveModules.FrontRight, SwerveModules.BackLeft, SwerveModules.BackRight);
}
