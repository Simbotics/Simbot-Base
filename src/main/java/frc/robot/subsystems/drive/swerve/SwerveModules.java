...
public class SwerveModules {
    public static final SwerveModuleConstants FrontLeft = DriveConstants.ConstantCreator.createModuleConstants(
    ...
    public static final SwerveModuleConstants FrontRight = DriveConstants.ConstantCreator.createModuleConstants(
    ...
    public static final SwerveModuleConstants BackLeft = DriveConstants.ConstantCreator.createModuleConstants(
    ...
    public static final SwerveModuleConstants BackRight = DriveConstants.ConstantCreator.createModuleConstants(
