...
public class LEDConstants {
  ...
  public static final int numberOfSegments =
      4; // The number of segments, or LED strips there are attached to each other.
  ...
  public static AddressableLEDBuffer buffer =
      new AddressableLEDBuffer(
          (numberOfSegments * ledsPerSegment)); // The buffer that holds the LED data
}
