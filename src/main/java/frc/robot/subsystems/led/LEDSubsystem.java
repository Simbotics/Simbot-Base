...
public class LEDSubsystem extends SubsystemBase {
    ...
    public void initialize() {
        ...
        LEDConstants.leds.setLength((LEDConstants.numberOfSegments * LEDConstants.ledsPerSegment)); // Set the length of the LED strip
        LEDConstants.leds.start(); // Start the LED strip
    }

    /**
     * Sets the mode for all segments available
     * @param ledMode The mode to set them all as. Please see the modes directory for all available modes
     */
