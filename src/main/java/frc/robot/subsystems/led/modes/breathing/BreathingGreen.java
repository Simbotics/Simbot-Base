...
public class BreathingGreen extends LEDMode {
  ...
  public void initialize() {
    this.cycle = 1;
    System.out.println("Starting the BreathingGreen LED mode"); // Say we are using the BreathingGreen LED mode
  }
  ...
  public void periodic(int segmentIndex) {
    ...
    Color breathingGreenColour = new Color(0, (Math.sin(Math.PI * this.cycle / 80.0) + 1.0) / 2.0, 0);
