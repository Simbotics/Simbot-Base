...
public class SolidBlue extends LEDMode {
  ...
  public void initialize() {
    System.out.println("Starting the SolidBlue LED mode"); // Say we are using the SolidBlue LED mode
  }
  ...
  public void periodic(int segmentIndex) {
    ...
    LEDColour blueLedColour = new LEDColour(0, 0, 255); // Create a new RGB sequence with only blue value being added
