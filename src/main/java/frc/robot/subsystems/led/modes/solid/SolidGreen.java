...
public class SolidGreen extends LEDMode {
  ...
  public void initialize() {
    System.out.println("Starting the SolidGreen LED mode"); // Say we are using the SolidGreen LED mode
  }
  ...
  public void periodic(int segmentIndex) {
    ...
    LEDColour greenLedColour = new LEDColour(0, 255, 0); // Create a new RGB sequence with only green value being added
