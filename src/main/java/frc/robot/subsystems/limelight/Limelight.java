...
public class Limelight implements LimelightIO {
     ...
     * 
     * @param limelightLEDMode The led mode to set the limelight to (see
     *                         LimelightLEDMode.java for options)
     */
     ...
     * 
     * @param stream The streaming mode to set the limelight to as a limelight
     *               stream type
     */
